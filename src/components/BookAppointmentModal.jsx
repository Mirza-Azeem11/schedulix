...
const BookAppointmentModal = ({ isOpen, onClose, patientId, onSuccess }) => {
  ...
  const loadOrganizations = async () => {
    ...
    try {
      ...
      console.log('Parsed organizations:', orgList);
  ...
  const handleDoctorSelect = (doctor) => {
    ...
    setDoctorSearch(`Dr. ${doctor.User?.first_name || doctor.first_name} ${doctor.User?.last_name || doctor.last_name}`);
  };
